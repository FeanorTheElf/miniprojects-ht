...
\begin{proof}
    ...
    By Bezout's theorem \cite[Corollary I.7.8]{hartshorne}, it follows that $E$ and $E'$ share an irreducible component of dimension $\geq 1$, but since both are Elliptic Curves, they are irreducible of dimension $1$, so we find $E = E'$.
\end{proof}
