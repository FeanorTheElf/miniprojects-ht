...
\begin{lemma}
    ...
    Then there exists $P \in E(k)$ of order 4 if and only if $k$ has a root of
    \begin{equation*}
        \left(\mu^4 + 2(\alpha + \beta)\mu^2 + (\alpha - \beta)^2\right)\left(\mu^4 + (2\beta - 4\alpha)\mu^2 + \beta^2\right)\left(\mu^4 + (2\alpha - 4\beta)\mu^2 + \alpha^2\right)
    \end{equation*}
\end{lemma}
\begin{proof}
    ...
    \begin{align*}
        ...
        =& 2\alpha\gamma(\alpha - \beta) + \alpha\beta(\beta - \alpha) = \alpha(\alpha - \beta)(2\gamma - \beta) = (\gamma - \alpha)^2\mu^2
    \end{align*}
