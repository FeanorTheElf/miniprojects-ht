...
\begin{example}[4(ii)]
    ...
    Hence, it is left to consider $r = 1$ and $r = 2089$.
    Notice that the equations
    \begin{equation*}
        l^4 - 92 l^2 m^2 + 2089 m^4 = n^2 \quad \text{and} \quad 2089 l^4 - 92 l^2 m^2 + 1 m^4 = n^2
    \end{equation*}
    are symmetric w.r.t. swapping $l, m$.

    Hence we only have the obvious solutions $(l, m, n) = (1, 0, 1)$ and $(l, m, n) = (0, 1, 1)$ that give the points $(0, 0)$ and $\O$.
    So $E'(\Q)/\phi(E(\Q)) = \langle (0, 0) \rangle$.
