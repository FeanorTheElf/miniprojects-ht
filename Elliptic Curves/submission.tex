...
For example, I would find it interesting to study whether the fact that isogenies preserve the rank allows to prove more statements or compute the rank in more cases.
